...
\item Por último, se evalúa dentro de un ciclo 	si $seleccionados$ en actual es verdadero, en cuyo caso se realiza \textbf{push$\_$back} sobre el que le sigue . Dicho ciclo 


\item La complejidad del algoritmo \textbf{Sort} es .
...
\item La complejidad del algoritmo . 
