...
Dado que las complejidades dentro de la función se suman, 
lo cual la complejidad final es O($n\ log\ n$) + O($n$) lo cual esta acotado asintóticamente por O($n\ log\ n$), que es lo que queriamos ver.
