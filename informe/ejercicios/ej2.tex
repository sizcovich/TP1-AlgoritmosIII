...
Resolvimos el problema ordenando los cursos por fecha de fin y tomando siemrpe el menor curso (en términos de finalización) y agregandolo a la solucion siempre y cuando no se solape con los cursos que ya agregue como solucion.
