...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=120pt]{../imgs/instanciaposible_ej3_in1.jpg}
	\end{center}
\caption{Entrada de la instancia posible 1}
\end{figure}
