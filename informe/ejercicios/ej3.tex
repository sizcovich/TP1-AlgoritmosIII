...
El tamaño de entrada en todos los casos se encuentra definido en función de la cantidad de casilleros del piso del museo, siendo $n$ el ancho de la matriz que representa la entrada y $m$ el alto.
...
En este caso vemos que, efectivamente, la función crece aproximándose a la complejidad definida. Este tipo de casos aleatorios se encuentran definidos en función a tableros cuya cantidad de elementos se compone por un 20\% de paredes, 10\% de casilleros importantes y 70\% de casilleros vacíos. Este gráfico representa los datos obtenidos luego de varias ejecuciones del algoritmo con diferentes entradas aleatorias con iguales porcentajes y diferente distribución que luego fueron promediados para minimizar los casos particulares en donde por diversos motivos (como por ejemplo las podas) la ejecución terminara mucho antes.
