...
\item Tambien, quisimos comprobar qué ocurría al tener dos o mas camiones con la misma carga, para asi ver el orden de salida. Pudimos constatar que el orden de salida es el correcto, es decir, no importa la carga de los camiones, retorna por orden de carga. \newline
