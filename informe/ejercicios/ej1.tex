...
\newline
Adaptamos la estructura del heap de la siguiente manera:
\begin{itemize}
\item Cada nodo representa la capacidad de carga disponible correspondiente a un camión determinado en un momento dado.
