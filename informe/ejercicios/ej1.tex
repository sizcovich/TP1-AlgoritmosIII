...
Para adaptar el problema de Pascual al heap, decidimos que cada nodo representa la capacidad de carga disponible correspondiente a un camión determinado en un momento dado.
